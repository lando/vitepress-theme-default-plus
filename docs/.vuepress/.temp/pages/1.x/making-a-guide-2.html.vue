...
<li><RouterLink to="/1.x/making-a-guide.html">Autopopulating data from GitHub</RouterLink></li>
</ul>
<h2 id="manually-entering-data" tabindex="-1"><a class="header-anchor" href="#manually-entering-data" aria-hidden="true">#</a> Manually entering data</h2>
<p>To manually enter authorship, update time and edit link information manually just add some combination of the below frontmatter to the top of your guide's markdown file.</p>
...
<div class="custom-container tip"><p class="custom-container-title">Timestamp in ms</p>
<p>Note that the update timestamp is in milliseconds and not seconds!</p>
</div>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>You can check out the full markdown file that generated this page <a href="https://github.com/lando/vuepress-theme-default-plus/blob/main/docs/making-a-guide-2.html" target="_blank" rel="noopener noreferrer">here<ExternalLinkIcon/></a>. If you are interested in automatically setting the <code v-pre>authors</code>, <code v-pre>date</code> and edit link then check out <RouterLink to="/1.x/making-a-guide.html">Making a Guide</RouterLink></p>
</div></template>
