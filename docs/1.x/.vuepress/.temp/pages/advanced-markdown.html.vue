<template><div><p>This theme provides a bunch of <RouterLink to="/config.html#custom-containers">custom markdown containers</RouterLink> that can be used on their own. They can also be combined and wrapped together. Here is some content that demonstrates that.</p>
...
<div class="custom-container card"><p class="custom-container-title">Cat 1</p>
<p><img src="https://media0.giphy.com/media/SUWn1xWsXKDbz6Y1Dx/giphy.gif" alt="Cat 1"></p>
</div>
</div>
<div class="custom-container third">
<div class="custom-container card"><p class="custom-container-title">Cat 2</p>
<p><img src="https://media0.giphy.com/media/rxYG6rKr0iQla/200.gif" alt="Cat 2"></p>
</div>
</div>
<div class="custom-container third">
<div class="custom-container card"><p class="custom-container-title">Cat 3</p>
<p><img src="https://media2.giphy.com/media/YRVP7mapl24G6RNkwJ/200.gif" alt="Cat 3"></p>
</div>
</div>
